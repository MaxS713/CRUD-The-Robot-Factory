      ...
      <>
        <div id="confirm-background">
          <div id="confirm-content">
            ...
            <p>He has {props.robotsAmountList[props.selectedUserIndex]} robots and 1 defensive turret.</p>
            <p>He owns {props.resourcesAmountList[props.selectedUserIndex]} resources.</p>
